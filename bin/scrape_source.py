...
@click.option('--host', required=False, metavar='HOST', help="Call this host instead of scraper.bazardelux.com", default='scraper.bazardelux.com')
...
def main(source, scan, scrape, host, port, async, limit_count, back_secs):
    ...
    endpoint_url = '%s://%s:%s/v1/scraper/%s' % (
